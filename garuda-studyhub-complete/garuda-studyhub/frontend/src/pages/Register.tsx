            ...
            <form onSubmit={submit} className="space-y-5">
              <Field label="Full Name">
                <div className="relative">
                  ...
                  <Input required placeholder="e.g. Rahul Sharma" className="!pl-11" value={form.name} onChange={set('name')} />
                </div>
              </Field>
              <div className="grid sm:grid-cols-2 gap-5">
                <Field label="Email Address">
                  <div className="relative">
                    ...
                    <Input type="email" required placeholder="you@example.com" className="!pl-11" value={form.email} onChange={set('email')} />
                  </div>
                </Field>
                <Field label="Mobile">
                  <div className="relative">
                    <Phone size={18} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-ink-400" />
                    <Input placeholder="9876543210" className="!pl-11" value={form.phone} onChange={set('phone')} />
                  </div>
                </Field>
              </div>
              <div className="grid sm:grid-cols-2 gap-5">
                <Field label="Password">
                  <div className="relative">
                    ...
                    <Input type={show ? 'text' : 'password'} required placeholder="Min 8 characters" className="!pl-11 !pr-11" value={form.password} onChange={set('password')} />
                ...
                <Field label="Confirm Password">
                  <div className="relative">
                    <Lock size={18} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-ink-400" />
                    <Input type={show ? 'text' : 'password'} required placeholder="Repeat password" className="!pl-11" value={form.confirm} onChange={set('confirm')} />
                  </div>
                </Field>
              </div>
