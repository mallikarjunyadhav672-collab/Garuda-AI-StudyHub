            ...
            <form onSubmit={submit} className="space-y-5">
              <Field label="Email Address">
                <div className="relative">
                  ...
                  <Input type="email" required placeholder="you@example.com" className="!pl-11" value={email} onChange={(e) => setEmail(e.target.value)} />
                </div>
              </Field>
              <Field label="Password">
                <div className="relative">
                  <Lock size={18} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-ink-400" />
                  <Input type={show ? 'text' : 'password'} required placeholder="••••••••" className="!pl-11 !pr-11" value={password} onChange={(e) => setPassword(e.target.value)} />
